...
book1 = book(None, "Tu galfsdfsi", "Josef Murphy", 25.05)
# create_book(book1)
...
def update_book(book):
    query = """UPDATE books SET book_name = 'Belekas' WHERE book_name = (?) OR book_id = (?) OR author = (?) OR 
        selling_price = (?) """
...
# Senas metodas virsuje sutrumpintas
